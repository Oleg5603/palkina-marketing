...
const HERO_VARIANTS = {
  специалист: {
    ...
    title:    'Чувствуете, что стали чужими — хотя живёте вместе?',
    subtitle: 'Помогаю парам восстановить близость и научиться слышать друг друга. Онлайн, конфиденциально, без давления.',
